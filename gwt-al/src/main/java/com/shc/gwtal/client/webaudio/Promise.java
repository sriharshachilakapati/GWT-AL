...
public class Promise<T> extends JavaScriptObject
{
    ...
    public final native Promise<T> onError(OnRejected onRejected) /*-{
        ...
        {
            if (reason === undefined)
                onRejected.@com.shc.gwtal.client.webaudio.Promise.OnRejected::invoke(*)(null);
            else
                onRejected.@com.shc.gwtal.client.webaudio.Promise.OnRejected::invoke(*)(reason);
        });
    }-*/;
    ...
    public final native Promise<T> then(OnFulfilled<T> onFulfilled, OnRejected onRejected) /*-{
        return this.then(
            ...
            {
                if (value === undefined)
                    onFulfilled.@com.shc.gwtal.client.webaudio.Promise.OnFulfilled::invoke(*)(null);
                else
                    onFulfilled.@com.shc.gwtal.client.webaudio.Promise.OnFulfilled::invoke(*)(value);
            },
